...
From Calling Bullshit I took two `CLAUDE.md` rules: give every reading a locator plus a link or
...
and carry the heading; its content and placement remain editorial
...
from several workshops and added a test scanning built pages for
`reveal/` links
