...
Before you commit an edge to your tree, check it against the check-stage
table below: pick the two witnesses and see which points they share and how
strong each one is. This reports evidence strength only — it never tells you
whether the edge is in the real tree, since that answer is still locked
behind `reveal/`.
