...
<PredictionCheck
  ...
  whatYouShouldFind="The comparison you were handed changes two things: the cycle count goes from 1 to 10, and the bitrate goes from 320 to 96. Its 9.5-point difference is there in the numbers, and it is not evidence about cycles, because you cannot say which variable produced it."
/>
...
<FiveMinuteCheck sessionSlug="03-perceptual">
