...
<PredictionCheck
  ...
  whatYouShouldFind="Both routes fit. Dimensions, subsampling and the missing EXIF are identical either way, and the predicted file sizes are 6 KB and 7 KB from the observation, both inside the 15 KB rule."
/>
...
<FiveMinuteCheck sessionSlug="04-poor-image">
