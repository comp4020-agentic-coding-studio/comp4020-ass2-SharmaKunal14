...
<PredictionCheck
  ...
  whatYouShouldFind="Inside the photocopy channel the totals rise with the number of operations. The control ran the same eight operations and came back with none."
/>
...
If you want to watch this compounding effect happen live on ordinary text
before you start counting the card, try the
[chain simulator](/simulator/?from=01-photocopy#chain-simulator). To practise
marking a misreading against an illegible mark before you do it on the card
itself, try the
[character-diff visualizer](/simulator/?from=01-photocopy#character-diff)
instead. Both are a supplement to this workshop, not a substitute for the
pack or the worked answer.
...
<FiveMinuteCheck sessionSlug="01-photocopy">
